...
const Sobre = () => {
    return (
        <>
            ...
            <div>
                <div className='img-video'><img src="video-sobre.svg" alt="" />
            ...
            <div className='all'>
                <div className='container'>
                    <div className='galeria'>
                        <div className="img-box"><h3>André Pinheiro</h3></div>
                        <div className="img-box"><h3>Aline Batista</h3></div>
                        <div className="img-box"><h3>Camilly Maria</h3></div>
                        <div className="img-box"><h3>Gabriela Farias</h3></div>
                        <div className="img-box"><h3>Filipe......</h3></div>
